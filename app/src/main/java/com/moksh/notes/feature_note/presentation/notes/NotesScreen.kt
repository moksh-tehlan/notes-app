...
import com.moksh.notes.feature_note.presentation.notes.components.NotesItem
import com.moksh.notes.feature_note.presentation.notes.components.OrderSection
        ...
        Column(
            ...
            Row(
                ...
                IconButton(
                    ...
                    Icon(imageVector = Icons.Default.Star, contentDescription = "By order")
                }
            }
            AnimatedVisibility(
                ...
                OrderSection(modifier = Modifier.fillMaxWidth().padding(vertical = 16.dp),
